...
public class TableGeneratorDialog extends JDialog implements FocusListener {
    ...
    private void initComponents() {
        ...
        modifierField2.setToolTipText(MvplanInstance.getMvplan().getResource("mvplan.gui.TableGeneratorDialog.modifierTip.text"));
        jPanel1.add(modifierField2);

        modifierField3.setColumns(3);
        modifierField3.setText("0");
        modifierField3.setToolTipText(MvplanInstance.getMvplan().getResource("mvplan.gui.TableGeneratorDialog.modifierTip.text"));
        jPanel1.add(modifierField3);

        modifierField4.setColumns(3);
        modifierField4.setText("0");
        modifierField4.setToolTipText(MvplanInstance.getMvplan().getResource("mvplan.gui.TableGeneratorDialog.modifierTip.text"));
        ...
        okButton.setText(MvplanInstance.getMvplan().getResource("mvplan.gui.TableGeneratorDialog.okButton.text"));
        ...
        cancelButton.setText(MvplanInstance.getMvplan().getResource("mvplan.gui.TableGeneratorDialog.cancelButton.text"));
