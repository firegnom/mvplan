...
public class SegmentDeco extends SegmentAbstract
{
    ...
    public double gasUsed()
    {
        ...
        double p;   // pressure
        p=(depth+Mvplan.prefs.getPAmb())/Mvplan.prefs.getPConversion();    // Convert to pressure (atm);
        return( p * time * Mvplan.prefs.getDecoRMV());
    }
    ...
    public String toStringLong()
    {
        ...
        return String.format("DECO:%1$3.0f"+Mvplan.prefs.getDepthShortString()+" for %2$02d:%3$02d [%4$3.0f] on %5$s, SP: %6$3.1f, END:%7$3.0f"+Mvplan.prefs.getDepthShortString()+" M-Value: %8$02.0f%% [%9$02d], GF: %10$02.0f%%",
